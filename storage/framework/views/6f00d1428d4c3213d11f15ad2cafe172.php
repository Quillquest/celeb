...
<?php $__env->startSection('content'); ?>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4"
        ...
        <div class="absolute inset-0 overflow-hidden">
            ...
            <div
                class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-accent-500/10 rounded-full blur-3xl animate-pulse animation-delay-2000">
            </div>
            <div
                class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-primary-400/5 to-accent-500/5 rounded-full blur-3xl">
            </div>
        </div>
        ...
        <div class="relative w-full max-w-md" x-show="mounted" x-transition:enter="transition ease-out duration-700 transform"
            ...
            <!-- Main Card -->
            <div
                class="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 rounded-2xl p-8 shadow-2xl">
                ...
                <?php if($errors->any()): ?>
                    <div x-data="{ show: true }" x-show="show" x-transition:enter="transition ease-out duration-300"
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1">
                                <h3 class="text-sm font-medium text-red-800 dark:text-red-200 mb-2">Authentication Error
                                </h3>
                ...
                <!-- Login Form -->
                <form class="space-y-6" action="<?php echo e(route('login')); ?>" method="POST" x-data="{ isSubmitting: false }"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-blue-600/10 rounded-xl blur-sm group-focus-within:blur-md transition-all duration-300">
                            </div>
                    ...
                    <button type="submit" :disabled="isSubmitting" class="relative w-full group overflow-hidden">
                        <!-- Button Glow Effect -->
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl blur-sm group-hover:blur-md transition-all duration-300">
                        </div>

                        <!-- Button Content -->
                        <div
                            class="relative bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-4 px-6 rounded-xl flex items-center justify-center space-x-2 transform group-hover:scale-[1.02] group-active:scale-[0.98] transition-all duration-200">
                    ...
                    <?php if($settings->enable_social_login == 'yes'): ?>
                        ...
                        <a href="<?php echo e(route('social.redirect', ['social' => 'google'])); ?>" class="relative w-full group">
                            <div
                                class="absolute inset-0 bg-gray-50 dark:bg-gray-700/50 rounded-xl blur-sm group-hover:blur-md transition-all duration-300">
                            </div>
                            <div
                                class="relative bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white py-3 px-4 rounded-xl flex items-center justify-center space-x-3 hover:bg-gray-100 dark:hover:bg-gray-600/50 transition-all duration-300 backdrop-blur-sm">
...
<?php echo $__env->make('layouts.base1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/Websites/Broker/Celebrity/Celebrity/resources/views/auth/modern_login.blade.php ENDPATH**/ ?>