            ...
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <div class="flex-shrink-0">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-2">
                        ...
                        <!-- <span class="text-xl lg:text-2xl font-display font-bold text-gray-900 dark:text-white hidden sm:block"><?php echo e($settings->site_name); ?></span> -->
                    </a>
                </div>
...
<?php /**PATH /Users/user/Desktop/Websites/Broker/Celebrity/Celebrity/resources/views/layouts/modern.blade.php ENDPATH**/ ?>