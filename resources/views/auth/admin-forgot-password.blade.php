    ...
    <div class="row align-items-center justify-content-center vh-100">
        <div class="col-11 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 py-6">
            ...
            <p class="text-secondary text-center">
                Enter your admin email address and we'll send you an email with instructions to reset your password
            </p>
                    ...
                    <div class="col-12">
                        <div class="mb-4">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                                value="{{ old('email') }}" placeholder="Enter your admin email address" required>
                            @error('email')
