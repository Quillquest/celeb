        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">{{ $settings->contact_email ?? 'support@celebritybooking.com' }}</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">{{ $settings->whatsapp ?? '+1 (555) 123-4567' }}</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">{{ $settings->locations ?? 'Los Angeles, CA 90210' }}</p>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                    ...
                    <!-- Contact Form -->
                    <form action="{{ route('contact.send') }}" method="POST" class="space-y-6" x-data="contactForm()">
                        @csrf
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        required
                                        class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300 @error('name') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        required
                                        class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300 @error('email') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300 @error('phone') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select
                                        ...
                                        name="subject"
                                        required
                                        class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300 @error('subject') border-red-500 @enderror"
                                    >
                                        <option value="">Select a subject</option>
                                        <option value="General Inquiry" {{ old('subject') == 'General Inquiry' ? 'selected' : '' }}>General Inquiry</option>
                                        <option value="Celebrity Booking" {{ old('subject') == 'Celebrity Booking' ? 'selected' : '' }}>Celebrity Booking</option>
                                        <option value="Event Planning" {{ old('subject') == 'Event Planning' ? 'selected' : '' }}>Event Planning</option>
                                        <option value="Pricing Information" {{ old('subject') == 'Pricing Information' ? 'selected' : '' }}>Pricing Information</option>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea
                                    ...
                                    rows="6"
                                    required
                                    class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300 resize-none @error('message') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                <label class="relative flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors duration-300 has-[:checked]:border-green-500 has-[:checked]:bg-green-50">
                                    <input type="radio" name="priority" value="low" {{ old('priority', 'normal') == 'low' ? 'checked' : '' }} class="sr-only peer">
                                    <div class="flex items-center">
                                ...
                                <label class="relative flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors duration-300 has-[:checked]:border-yellow-500 has-[:checked]:bg-yellow-50">
                                    <input type="radio" name="priority" value="normal" {{ old('priority', 'normal') == 'normal' ? 'checked' : '' }} class="sr-only peer">
                                    <div class="flex items-center">
                                ...
                                <label class="relative flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors duration-300 has-[:checked]:border-red-500 has-[:checked]:bg-red-50">
                                    <input type="radio" name="priority" value="high" {{ old('priority', 'normal') == 'high' ? 'checked' : '' }} class="sr-only peer">
                                    <div class="flex items-center">
