    ...
    <div class="main-panel">
        <div class="content">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h3 class="fw-bold mb-3">About jedi Technology</h3>
                    ...
                    <div class="col-12">
                        <div class="card shadow-lg border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                            <div class="card-body text-center text-white py-5">
                                ...
                                <h1 class="display-4 fw-bold mb-3">jedi Technology</h1>
                                ...
                                <div class="d-flex justify-content-center gap-3 flex-wrap">
                                    <a href="https://wa.me/+2349162671360" target="_blank" class="btn btn-light btn-lg px-4">
                                        <i class="fab fa-telegram me-2"></i>Get Support
                                    </a>
                                    <a href="https://wa.me/+2349162671360" target="_blank" class="btn btn-outline-light btn-lg px-4">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white rounded">
                                                    ...
                                                    <a href="https://wa.me/+2349162671360" target="_blank" class="btn btn-primary btn-sm">Join Channel</a>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white rounded">
                                                    ...
                                                    <a href=https://wa.me/+2349162671360" target="_blank" class="btn btn-primary btn-sm">jeditech</a>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white rounded">
                                                    ...
                                                    <a href="https://wa.me/+2349162671360" class="btn btn-primary btn-sm"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
