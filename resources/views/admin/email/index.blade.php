                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('sendmailtoall') }}">
                                    ...
                                    <div class=" form-group">
                                        <h6 class="text-{{ $text }}">Enter Email</h6>
                                        <input type="email" aria-label="" name="email" class="form-control">
                                    </div>
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" aria-label="Hello" value="Hello" name="greet"
                                                class="form-control">
                                            <input type="text" aria-label="Investor" name="title" class="form-control">
                                        </div>
                                    </div>
                                    <div class=" form-group">
