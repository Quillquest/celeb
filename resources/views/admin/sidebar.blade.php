        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                @if (Auth('admin')->User()->type == 'Super Admin' || Auth('admin')->User()->type == 'Admin')
                    ...
                    <li class="nav-item {{ request()->routeIs('create_celebrity') ? 'active' : '' }}">
                        <a href="{{ route('create_celebrity') }}">
                            <i class="fa fa-star" aria-hidden="true"></i>
                            <p>Create Celebrity</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item {{ request()->routeIs('admin.contact-messages.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.contact-messages.index') }}">
                            ...
                            @php
                                $unreadCount = \App\Models\Notification::where('title', 'LIKE', 'Contact Message:%')->where('is_read', false)->count();
                            @endphp
                            @if($unreadCount > 0)
