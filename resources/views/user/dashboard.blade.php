                ...
                <div class="lg:col-span-1">
                    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
                        ...
                        <div class="bg-gradient-to-r from-primary-600 to-primary-800 px-6 py-8 text-center">
                            ...
                            <p class="text-primary-200">{{ Auth::user()->email }}</p>
                        </div>

                        <!-- User Menu -->
                        <nav class="py-3" x-data="{ activeTab: 'dashboard' }">
                            <a href="{{ route('user.dashboard') }}" @click="activeTab = 'dashboard'"
                            ...
                            <a href="{{ route('booking.history') }}" @click="activeTab = 'bookings'"
                            ...
                            <a href="{{ route('notifications.index') }}" @click="activeTab = 'notifications'"
                            ...
                            <a href="{{ route('profile.show') }}" @click="activeTab = 'profile'"
                            ...
                            <a href="{{ route('profile.show') }}#password" @click="activeTab = 'security'"
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden mt-6">
                        ...
                        <div class="px-6 py-4 space-y-4">
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="text-gray-900 dark:text-white font-medium">{{ Auth::user()->created_at->format('M j, Y') }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500 dark:text-gray-400">Total Bookings</span>
                                <span class="text-gray-900 dark:text-white font-medium">{{ $bookings->count() }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500 dark:text-gray-400">Upcoming Events</span>
                                <span class="text-gray-900 dark:text-white font-medium">{{ $upcomingBookings }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd>
                                                <span
                                                    class="text-lg font-semibold text-gray-900 dark:text-white">{{ $upcomingBookings }}</span>
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd>
                                                <span
                                                    class="text-lg font-semibold text-gray-900 dark:text-white">{{ $pendingBookings }}</span>
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd>
                                                <span
                                                    class="text-lg font-semibold text-gray-900 dark:text-white">{{ $completedBookings }}</span>
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
                                                ...
                                                <div class="mt-2 flex items-center">
                                                    @if ($booking->booking_type == 'donation')
                                                        ...
                                                        <span class="text-xs text-gray-700 dark:text-gray-300 font-medium">
                                                            Donation Amount: ${{ number_format($booking->booking_fee, 2) }}
                                                        </span>
                                                    @elseif($booking->booking_type == 'fan_card')
                                                        <i data-lucide="star"
                                                            class="h-4 w-4 text-purple-500 dark:text-purple-400 mr-1.5"></i>
                                                        <span class="text-xs text-gray-700 dark:text-gray-300 font-medium">
                                                            {{ ucfirst(json_decode($booking->notes)->membership_tier ?? 'Gold') }}
                                                            VIP Membership
                                                        </span>
                                                    @else
                                                        <i data-lucide="calendar"
                                                        ...
                                                        <span class="text-xs text-gray-500 dark:text-gray-400">
                                                            {{ $booking->event_date->format('M j, Y') }} at
                                                ...
                                                <div class="mt-1 flex items-center">
                                                    @if ($booking->booking_type == 'donation')
                                                        ...
                                                        <span
                                                            ...
                                                            Supporting:
                                                            {{ json_decode($booking->notes)->charity_preference ?? 'Charity & Community Causes' }}
                                                        </span>
                                                    @elseif($booking->booking_type == 'fan_card')
                                        ...
                                        <div class="p-4">
                                            ...
                                            @if ($celebrity->known_for)
                                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                                    {{ $celebrity->known_for }}</p>
                                            @endif
                                            <div class="mt-3 flex flex-col space-y-2">
                                                <div class="flex justify-between items-center">
                                                    <span
                                                        class="text-xs font-medium text-primary-600">${{ number_format($celebrity->booking_fee, 0) }}</span>
                                                </div>

                                                <!-- Action Buttons Grid -->
                                                <div class="grid grid-cols-2 gap-1.5">
                                                    <a href="{{ route('booking.form', $celebrity->id) }}"
                    ...
                    <div
                        ...
                        <div class="relative p-6 lg:p-8" x-data="{ isLoading: false, formValid: false }" x-init="$watch('formValid', value => {
                            ...
                            <form action="{{ route('booking.guest.find') }}" method="POST" @submit="isLoading = true"
