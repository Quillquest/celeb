...
<head>
    ...
    <title>{{ $settings->site_name }} - Book Your Favorite Celebrity</title>
            ...
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <div class="flex-shrink-0">
                    <a href="{{ route('home') }}" class="flex items-center space-x-2">
                        ...
                        <!-- <span class="text-xl lg:text-2xl font-display font-bold text-gray-900 hidden sm:block">{{ $settings->site_name }}</span> -->
                    </a>
                </div>
